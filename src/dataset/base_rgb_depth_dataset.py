...
class BaseRGBDepthDataset(Dataset):
    def __init__(
        self,
        mode: DatasetMode,
    ...
    def _get_data_item(self, index):
        global_rel_path, rolling_rel_path, depth_rel_path = self._get_data_path(index=index)
        ...
        depth_data = self._load_depth_data(depth_rel_path)
    ...
    def _load_depth_data(self, depth_rel_path):
        ...
        # print(depth_raw_linear.shape) # [1, H, W]
    ...
    def _get_data_path(self, index):
        ...
        return global_rel_path, rolling_rel_path, depth_rel_path
